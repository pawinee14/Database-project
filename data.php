        ...
        <!--แท็บบาร์-->
             <nav class="navbar navbar-expand-lg navbar navbar-light navbar-warning bg-warning" style="background-color: #e3f2fd;">
                 <div class="container-fluid">
                    ...
                    <a class="nav-link dropdown-toggle active" href="data.php" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        AIHIT
                    </a>
...
<body>
        ...
        <figure class="text-center text-dark">
            <p class="h1">Most Liked Companies</p>
        </figure>
        <!--กราฟ-->
        <section id="graph">
            <div class="container">
